...
class Order {
	...
	function __construct($id, $created_date, $order_status_id, $staff_id, $customer_id, $shipping_fullname, $shipping_mobile, $payment_method, $shipping_ward_id, $shipping_housenumber_street, $shipping_fee, $delivered_date,$payment = null){
		$this->id = $id;
